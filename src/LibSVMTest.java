...
public class LibSVMTest {
	...
	/*	String[] trainArgs = {"-t","0","-d","2","-g","0.1617","-m","400","22.txt"};//directory of training file
		String modelFile = svm_train.main(trainArgs);
		String[] testArgs = {"tiff_predict_data_processed.txt", modelFile, "result1.txt"};//directory of test file, model file, result file
		Double accuracy = svm_predict.main(testArgs);
		System.out.println("SVM Classification is done! The accuracy is " + accuracy);*/
